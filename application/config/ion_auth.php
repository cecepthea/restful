 ...
 */
$config['site_title']                 = "RESTful";       // Site Title, example.com
$config['admin_email']                = "rchiriac@kokmoka.com"; // Admin Email, admin@example.com
...
$config['message_start_delimiter'] = '<p class="ci-message">'; 	// Message start delimiter
$config['message_end_delimiter']   = '</p>'; 	// Message end delimiter
$config['error_start_delimiter']   = '<p class="ci-error">';		// Error mesage start delimiter
